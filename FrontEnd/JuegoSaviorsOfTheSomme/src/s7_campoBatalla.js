...
function CrearAvion(bando,num){
   ...
   var avion;
        ...
        if (bando == "Aliado"){
            avion = sceneJuego.physics.add.image( 0,0,"avionNegro");
            avion.bando = "Aliado";
            ...
            avion = sceneJuego.physics.add.image(700,200,"avionRojo");
            avion.bando = "Enemigo";    
