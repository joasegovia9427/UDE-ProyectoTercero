var Avion = new Phaser.Class({
  ...
  function Avion (scene, in_num, in_imagenAvionesPuntero, isCreacionAliados)
  {
      ...
      if (isCreacionAliados) {
        ...
        //this.physics.add.image(x,y,"avionNegro");//.setDisplayOrigin(0, 0);
        //this.physics.add.image(100,100,in_imagenAvionesPuntero);//.setDisplayOrigin(0, 0);
        this.bando = "Aliado";
/*         this.bullets_avion_Aliado = this.physics.add.group({
              classType: Bullet,
              maxSize: 5,
              runChildUpdate: true
          });
        ...
        this.physics.add.image(x,y,"avionRojo");//.setDisplayOrigin(0, 0);
        //this.physics.add.image(100,100,in_imagenAvionesPuntero);//.setDisplayOrigin(0, 0);
        this.bando = "Enemigo"; 
        
        this.bullets_avion_Enemigo = this.physics.add.group({
              classType: Bullet,
              maxSize: 5,
              runChildUpdate: true
          });
